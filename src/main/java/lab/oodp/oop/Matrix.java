...
public class Matrix {
    ...
    public String getRow(int row) {
    	...
    	rows = letters.substring(start,end);
    	
//    	String lines[];
//    	lines = new String[3];
//    	
//    	lines[0] = letters.substring(0,5);
//    	lines[1] = letters.substring(6,11);
//    	lines[2] = letters.substring(12,17);
    ...
    public String getLeftDiagonal(String row1, String row2, String row3) {
        ...
        String leftDiagonal = row1.substring(0,1)+" "+row2.substring(2,3)+" "+row3.substring(4,5);
    ...
    public String getRightDiagonal(String row1, String row2, String row3) {
    	...
    	String rightDiagonal = row1.substring(4,5)+" "+row2.substring(2,3)+" "+row3.substring(0,1);
